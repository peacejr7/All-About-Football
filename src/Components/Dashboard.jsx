...
function Dashboard() {
  return (
    ...
    <a href="#">
        <img class="w-auto h-6 sm:h-7" src="https://www.rebelsport.com.au/on/demandware.static/-/Sites-srg-internal-master-catalog/default/dw85642ff2/hof/230125-REBEL-Football-3D-Adidas-Oceaunz-r1.png" alt=""/>
    </a>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                ...
                <span class="mx-4 font-medium">BlogList</span>
            </a>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                ...
                <span class="mx-4 font-medium">All Teams</span>
            </a>
        ...
        <a href="#" class="flex items-center px-4 -mx-2">
            <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://www.rebelsport.com.au/on/demandware.static/-/Sites-srg-internal-master-catalog/default/dw85642ff2/hof/230125-REBEL-Football-3D-Adidas-Oceaunz-r1.png" alt="avatar" />
            <span class="mx-2 font-medium text-gray-800 dark:text-gray-200">Football</span>
        </a>
