...
function Table() {
  return (
    ...
    <div class="flex items-center gap-x-3">
        ...
        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400"> 200users</span>
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Kelly Dalula</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@kellydalula</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Design Manager</td>
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">kellydalula@example.com</td>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">RhineKyle</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@RhineKyle</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">RhineKyle@example.com</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                        <p class="px-3 py-1 text-xs text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">Design</p>
                                        <p class="px-3 py-1 text-xs text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">Product</p>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Roger Uwineza</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@Roger</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Roger@example.com</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                        <p class="px-3 py-1 text-xs text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">Design</p>
                                        <p class="px-3 py-1 text-xs text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">Product</p>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Moana Ashimwe</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@moanaashimwe</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">moanaashimwe@example.com</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                        <p class="px-3 py-1 text-xs text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">Design</p>
                                        <p class="px-3 py-1 text-xs text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">Product</p>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Flower Giraneza</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@flowergiraneza</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Flower@example.com</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                        <p class="px-3 py-1 text-xs text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">Design</p>
                                        <p class="px-3 py-1 text-xs text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">Product</p>
